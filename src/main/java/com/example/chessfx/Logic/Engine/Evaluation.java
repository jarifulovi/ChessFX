...
public class Evaluation {
    ...
    private int getRatioValue(int ownPieceValue,int opponentPieceValue){
        ...
        double ratio = (ownPieceValue - opponentPieceValue) / totalValue;
    ...
    private int getEndGameEval(Bitboard bitboard,int[] pc,int point,int turn){
        ...
        // There won't be any queen as endgame
        ...
        // two rook endgame
        if((pc[logic.W_ROOK]==2 && totalMajorPiece==2)||(pc[logic.B_ROOK]==2 && totalMajorPiece==2)){
            return endgameEvaluation.twoRookOnlyEval(bitboard,point,turn);
        }
